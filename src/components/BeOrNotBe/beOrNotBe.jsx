        ...
        <Grid container justify='center' alignItems='center'>
          <Grid item xs={12} md={6}>
            <Box pt={10} pl={{md: 10, xs: 3}} pr={{md: 10, xs: 3}}  pb={5}>
              <Typography gutterBottom className={classes.whiteType} align='left' variant='h4'>Ser teatrerito o no ser, esa es la cuestión</Typography>
              <Typography className={classes.darkOrangeType}>
              A través del juego, el teatro y la danza los teatreritos se entretienen mientras desarrollan nuevas habilidades que los hacen más creativos, seguros y libres.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={6}>
            <Geometry src={geometrias} alt='geometrias teatreritos' />
          </Grid>
        </Grid>
      </Box>
